Public Class ListaReglas
    ...
    Private Sub CrearListaReglas()
        ...
        lista.Add(New ValidacionRegex("nombreProveedor", New Regex("^[\wáéíóúÁÉÍÓÚ\s]+$"), "Solo se permiten letras y números."))
        ...
        lista.Add(New ValidacionRegex("nombres", New Regex("^[a-zA-ZáéíóúÁÉÍÓÚ\s]+$"), "Solo se permiten letras y espacios."))
