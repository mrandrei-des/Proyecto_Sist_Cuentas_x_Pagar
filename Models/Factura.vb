Namespace Models
    Public Class Factura
        ...
        Public Sub New(idProveedor As Integer, tipoFactura As Integer, numeroFactura As String, observacion As String, fechaEmision As DateTime, estado As Integer, moneda As String, tipoCambio As Double, total As Double, saldoActual As Double)
